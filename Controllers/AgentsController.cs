...
namespace debtTrackingApp.Controllers
{
    ...
    {
        private readonly DebtTrackDBContext _context;

        public AgentsController(DebtTrackDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Agent>> PostAgent(Agent agent)
        {
          if (_context.Agents == null)
          {
              return Problem("Entity set 'DebtTrackDBContext.Agents'  is null.");
          }
